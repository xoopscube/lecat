...
define('_MD_LECAT_ERROR_MINLENGTH', 'Input field {0} with {1} or more characters.');
define('_MD_LECAT_ERROR_MAXLENGTH', 'Input field {0} with {1} or less characters.');
define('_MD_LECAT_ERROR_EXTENSION', 'Uploaded file\'s extension does not match any entry in the allowed list.');
define('_MD_LECAT_ERROR_INTRANGE', 'Incorrect value inputted : {0}.');
define('_MD_LECAT_ERROR_MIN', 'Enter input field {0} with {1} or more numeric value.');
define('_MD_LECAT_ERROR_MAX', 'Enter input field {0} with {1} or less numeric value.');
define('_MD_LECAT_ERROR_OBJECTEXIST', 'Incorrect value inputted : {0}.');
...
define('_MD_LECAT_LANG_PERMIT_EDIT', 'Permit Edit');
define('_MD_LECAT_LANG_PERMIT_DELETE', 'Permit Delete');
...
define('_MD_LECAT_LANG_DELETE_ALL_PERMIT', 'Delete all Permission on this category');
