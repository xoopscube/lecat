...
INSERT INTO `{prefix}_{dirname}_cat` (`cat_id`, `title`, `p_id`, `modules`, `description`, `weight`, `options`)
VALUES (1, 'General', 0, '', '', 10, '');
...
INSERT INTO `{prefix}_{dirname}_permit` (`permit_id`, `cat_id`, `groupid`, `permissions`)
VALUES (1, 0, 1, 'a:3:{s:6:"viewer";s:1:"1";s:6:"poster";s:1:"1";s:7:"manager";s:1:"1";}'),
